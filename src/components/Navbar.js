            ...
            <header className="text-gray-600 body-font">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    <Link href={`/`} className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                        <span className="ml-3 text-3xl text-red-600">NetFlix</span>
                    </Link>
                    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                        <Link href={`/`} className="mr-5 hover:text-red-600 font-bold    ">Home</Link>
                        <Link href={`/series`} className="mr-5 hover:text-red-600 font-bold ">Series</Link>
                        <Link href={`/movies`} className="mr-5 hover:text-red-600 font-bold ">Movies</Link>
