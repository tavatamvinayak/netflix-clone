        ...
        <section class="text-gray-600 body-font">
          <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            ...
            <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
              <h3 className="text-gray-500 text-xs tracking-widest title-font text-red-600 mb-1"> {main_data.type} </h3>
              <h2 className=" title-font text-5xl font-serif  font-medium text-red-600">{main_data.title} </h2>
              <p className="mt-1"> {`${main_data.synopsis} ...`} </p>
              <button className='p-2 border-2 border-red-400 my-3 hover:bg-red-500 rounded-2xl hover:text-white'> Watch now</button>
